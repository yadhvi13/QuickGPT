...
const [search, setSearch] = useState('')
  ...
  return (
    <div className='flex flex-col h-screen min-w-[18rem] p-5 dark:bg-gradient-to-b from-[#242124]/30 to-[#000000]/30 border-r border-[#80609F]/30 backdrop-blur-3xl transition-all duration-500 max-md:absolute left-0 z-1'>
      {/* logo */}
      <img
